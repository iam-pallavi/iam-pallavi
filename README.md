...
<img src="https://raw.githubusercontent.com/iam-pallavi/iam-pallavi/main/assets/banner.jpg" width="500px" height="150px" alt="Pallavi Sonawane - Cloud DevOps Engineer">

# P A L L A V I  S O N A W A N E

### **Cloud & DevOps Engineer • AWS • Automation • AI**
...
| [**Day 01 — Git & GitHub**](https://github.com/devopswithpallavi/30-days-of-devops/tree/main/day-01-git-github) | Git fundamentals, branching, version control and GitHub workflow |
| **AWS Cloud Labs** | Hands-on practice with AWS core services and cloud concepts |
| **Docker & Container Labs** | Containerization, Dockerfiles, images, networks and volumes |
| **CI/CD Projects** | Automated build, test and deployment workflows |
...
| 🔄 **CI/CD** | Jenkins, GitHub Actions & automated delivery |
| ☸️ **Kubernetes** | Pods, Deployments, Services & orchestration |
| 🏗️ **Terraform** | Infrastructure as Code & cloud automation |
| ⚙️ **Ansible** | Configuration management & automation |
| 🤖 **AI + Cloud** | Exploring AI-powered cloud and DevOps workflows |
...
`AWS Cloud Practitioner` • `Linux` • `Git & GitHub` • `Docker` • `Jenkins` • `CI/CD`

`Kubernetes` • `Terraform` • `Ansible` • `Python Automation` • `AI + Cloud`
